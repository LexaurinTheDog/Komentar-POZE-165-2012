# Část první, Hlava XIII — Společná ustanovení; státní správa a přestupky (§§ 48–55)

> **Téma kapitoly:** Hlava XIII uzavírá část první zákona o podporovaných zdrojích energie (POZE) a tvoří její procesní a sankční páteř. Zahrnuje: **kontrolu** dodržování zákona svěřenou Státní energetické inspekci (SEI) (§ 48), rozsáhlý **katalog přestupků** adresovaný výrobcům elektřiny, výrobcům tepla, výrobcům biometanu, dodavatelům a dalším subjektům (§ 49 — 27 skupin odstavců s individuálními sazbami pokut), **přestupky dodavatele leteckého paliva** s odkazem na přímo použitelný předpis EU (§ 49a), **společná procesní ustanovení k přestupkům** (§ 50 — 5letá promlčecí doba, příslušnost SEI), institutu **neoprávněně čerpané podpory** a jeho správy celními úřady (§ 51), **rozhodování sporů** Energetickým regulačním úřadem (ERÚ) (§ 52), rozsáhlá **zmocňovací ustanovení** svěřující prováděcí pravomoc Ministerstvu průmyslu a obchodu (MPO) a ERÚ (§ 53), **přechodná ustanovení** zachovávající práva na podporu z výroben uvedených do provozu před účinností zákona (§ 54) a **zrušovací ustanovení** (§ 55). Přestupkový systém POZE je lex specialis vůči obecnému přestupkovému zákonu č. 250/2016 Sb., který se použije subsidiárně pro otázky jím neupravené. Kapitola navazuje na [06-hlava12-doprava-biopaliva-vodik.md](06-hlava12-doprava-biopaliva-vodik.md) a předchází [08-casti2-7-zmeny-ucinnost.md](08-casti2-7-zmeny-ucinnost.md).
...
>
> *(2) Inspekce plní úkoly příslušného orgánu podle přímo použitelného předpisu Evropské unie upravujícího podmínky pro udržitelnou leteckou dopravu v oblasti leteckých paliv ve vztahu k dodavatelům leteckých paliv a provádí rovněž kontrolu dodržování jejich povinností podle tohoto přímo použitelného předpisu.*

**Výklad:**

#### Inspekce jako primární kontrolní orgán (odst. 1)

Zákon svěřuje kontrolní pravomoc výlučně **Státní energetické inspekci (SEI)** — správnímu orgánu zřízenému zákonem č. 458/2000 Sb. (energetický zákon). Rozsah kontroly pokrývá všechna ustanovení POZE kromě **správy odvodu**, která zůstává ve věcné působnosti celních úřadů (srov. § 51 odst. 4 — správu placení neoprávněně čerpané podpory vykonává celní úřad). Výjimka odvodu je systematická: odvod má daňovou povahu a jeho správa se řídí daňovým řádem (zákon č. 280/2009 Sb.), nikoli přestupkovým zákonem; jeho správci jsou proto celní orgány, nikoliv SEI.

Inspekce při výkonu kontroly postupuje podle kontrolního řádu (zákon č. 255/2012 Sb.) a ve věcech přestupkového řízení podle správního řádu (zákon č. 500/2004 Sb.) a přestupkového zákona (zákon č. 250/2016 Sb.). Subsidiární použití přestupkového zákona č. 250/2016 Sb. je klíčové: POZE stanoví pouze katalogy skutkových podstat a sazby pokut; procesní pravidla (zahájení řízení, dokazování, obnova řízení aj.) se řídí zákonem č. 250/2016 Sb.

#### Kontrola plnění povinností dodavatelů leteckých paliv (odst. 2)

Odst. 2 byl do zákona vložen v důsledku implementace nařízení EU o udržitelné letecké dopravě (ReFuelEU Aviation — nařízení EP a Rady č. 2023/2405). SEI plní roli **příslušného orgánu** pro dohled nad dodavateli leteckých paliv ve smyslu tohoto přímo použitelného předpisu EU. Povinnosti dodavatelů leteckých paliv jsou blíže rozebrány v části věnované § 47ba a v [06-hlava12-doprava-biopaliva-vodik.md](06-hlava12-doprava-biopaliva-vodik.md); příslušné přestupky jsou obsaženy v § 49a.
...
#### Systematika přestupkového katalogu — subjektový přístup

Zákon volí **subjektový přístup** k uspořádání katalogu přestupků: každý odstavec adresuje jiný typ povinného subjektu a popisuje skupinu povinností, jejichž nesplnění zakládá přestupkovou odpovědnost. Celkem § 49 v konsolidovaném znění k 1. 1. 2026 obsahuje **27 skupin odstavců** pokrývající 13 kategorií subjektů:

| Odst. | Subjekt |
|---|---|
| 1 | Výrobce (elektřiny obecně) |
| 2 | Výrobce elektřiny z OZE s čtvrthodinovým ZB nebo aukčním bonusem na elektřinu nevyužitou do sítě |
| 3 | Výrobce elektřiny z VKVET |
| 4 | Výrobce energie (záruky původu) |
| 5 | Výrobce tepla |
| 6 | Výrobce biometanu |
| 7 | Vykupující |
| 8 | Povinně vykupující (elektřina) |
| 9 | Výrobce paliva / dodavatel paliva / dovozce paliva z biomasy |
| 10 | Provozovatel PPS nebo PDS (elektroenergetika) |
| 11 | Provozovatel přepravní soustavy, PDS nebo jiný výrobce plynu |
| 12 | Držitel licence na rozvod tepelné energie |
| 13 | Držitel účtu (záruky původu) |
| 14 | Operátor trhu |
| 15 | Provozovatel přepravní soustavy nebo PDS (biometan, registrace) |
| 16 | Výrobce elektřiny z druhotných zdrojů |
| 17 | Držitel osvědčení o původu |
| 18 | Provozovatel soustavy (záruky původu) |
| 19 | Provozovatel dobíjecí stanice |
| 20 | Osoba odebírající plynné pohonné hmoty |
| 21 | Výrobce tepla z neobnovitelného zdroje |
| 22 | Výrobce paliv z lesní biomasy, prodejce nebo dodavatel |
| 23 | Osoba spotřebovávající vodík v průmyslu |
| 24 | Provozovatel soustavy zásobování tepelnou energií |
| 25 | Povinně vykupující plyn |
| 26 | Dodavatel plynných pohonných hmot |
| 27–30 | Sazby pokut |

#### Sazby pokut — přehled (odst. 27–30)

| Skupina přestupků | Sazba pokuty | Poznámky |
|---|---|---|
| Odst. 1–22, 23 písm. b) a c), 24, 25 a 26 písm. b), d) a e) | až 50 000 000 Kč | U výrobce, výrobce biometanu a výrobce tepla max. do výše ročního nároku na podporu; výjimky: odst. 1 písm. h), odst. 2, 4 písm. a), 5 písm. e), 6 písm. e) — pro tyto výjimky strop ročního nároku neplatí |
| Odst. 23 písm. a) — vodík | MJ × 0,6 Kč | Výpočtová sazba za chybějící obnovitelný vodík nebiologického původu |
| Odst. 26 písm. a) — biometán/RFNBO | MJ × 2 Kč | Výpočtová sazba za nedodané pokročilé palivo nebo RFNBO |
| Odst. 26 písm. c) — emise SKP | kg emisí × 10 Kč | Výpočtová sazba za nedosažené snížení emisí |

#### Vztah k zákonu č. 250/2016 Sb. o odpovědnosti za přestupky

§ 49 POZE je **speciálním zákonem** vůči přestupkovému zákonu č. 250/2016 Sb. POZE stanoví: (i) katalog skutkových podstat, (ii) sazby pokut. Všechny otázky neupravené POZE — zahájení řízení, dokazování, mírnější zacházení (§ 47 PřestZ), přiměřenost trestu (§ 37 PřestZ), promlčení (§ 30 PřestZ, avšak § 50 POZE je výslovně modifikuje) — se řídí zákonem č. 250/2016 Sb. Právnické a podnikající fyzické osoby nesou přestupkovou odpovědnost bez ohledu na zavinění (objektivní odpovědnost s liberačním důvodem podle § 21–22 PřestZ), pokud POZE liberační důvod výslovně nevylučuje — srov. § 49a odst. 3 pro přestupky dodavatelů leteckého paliva.

#### Odst. 11 písm. b) — textová anomálie zdroje
...
> **§ 49a**
>
> *(1) Dodavatel leteckého paliva se dopustí přestupku tím, že v rozporu s přímo použitelným předpisem Evropské unie upravujícím podmínky pro udržitelnou leteckou dopravu v oblasti leteckých paliv*
>
...
>
> *(3) Dodavatel leteckého paliva se odpovědnosti za přestupek podle odstavce 1 písm. a), d) nebo h) nemůže zprostit. Za tento přestupek se uloží pokuta ve výši od dolní hranice sazby pokuty stanovené podle přímo použitelného předpisu Evropské unie upravujícího podmínky pro udržitelnou leteckou dopravu v oblasti leteckých paliv do dvojnásobku takto stanovené dolní hranice sazby pokuty. Za tento přestupek nelze uložit správní trest propadnutí věci nebo náhradní hodnoty, od uložení správního trestu za tento přestupek nelze upustit ani podmíněně upustit a dolní hranici sazby pokuty za tento přestupek nelze mimořádně snížit.*

**Výklad:**

#### Postavení dodavatele leteckého paliva — přímá použitelnost nařízení EU

§ 49a byl vložen v souvislosti s nařízením EP a Rady (EU) 2023/2405 (ReFuelEU Aviation) o zajišťování rovných podmínek pro udržitelnou leteckou dopravu. POZE funguje jako zákon určující **příslušný vnitrostátní orgán** (SEI) a stanovující sankční rámec nad rámec přímo použitelného nařízení EU. Tato konstrukce — nařízení EU jako základ povinností, vnitrostátní zákon jako sankční doplněk — je v energetickém právu stále běžnější.

#### Dvouúrovňový sankční systém (odst. 2 a odst. 3)

Zákon konstruuje dvě skupiny přestupků s odlišnou přísností:

| Skupina (odst. 1) | Přestupky | Sankce | Zvláštnosti |
|---|---|---|---|
| „Méně závažné" (odst. 2) | písm. b), c), e), f), g) | až 50 000 000 Kč | Standardní sazba |
| „Nejzávažnější" (odst. 3) | písm. a), d), h) | od dolní hranice EU sazby do jejího dvojnásobku | Absolutní odpovědnost, zákaz liberace, zákaz podmíněného upuštění, zákaz mimořádného snížení, zákaz trestu propadnutí věci |
...
#### Modifikovaná promlčecí doba — lex specialis vůči přestupkovému zákonu (odst. 1)

Zákon č. 250/2016 Sb. o přestupcích (§ 30 odst. 1) stanoví obecnou promlčecí dobu přestupku na **3 roky** s absolutní lhůtou 5 let. POZE ji prodlužuje:
- **Promlčecí doba:** 5 let od spáchání přestupku (oproti 3 letům dle PřestZ).
- **Absolutní lhůta:** 8 let od spáchání, pokud byla promlčecí doba přerušena (oproti 5 letům dle PřestZ).

| | Zákon č. 250/2016 Sb. (obecně) | POZE § 50 (speciálně) |
|---|---|---|
| Promlčecí doba | 3 roky | 5 let |
| Absolutní zánik odpovědnosti | 5 let | 8 let (při přerušení) |

Prodloužení je odůvodněno **specifiky sektoru podporovaných zdrojů**: přestupky (zejména manipulace s měřením, nepředávání údajů OTE, neoprávněné čerpání podpory) mohou být zjistitelné až s odstupem v rámci sektorového šetření (§ 31) nebo auditů (§ 47ba), které mohou proběhnout i několik let po spáchání přestupku. Promlčecí dobu přerušují úkony směřující k zjištění přestupku nebo k zjištění pachatele (§ 32 odst. 1 PřestZ), např. zahájení řízení, výzvy ke sdělení údajů apod.
...
1. **Čerpání bez vzniku práva** — výrobce pobírá podporu, na niž vůbec nevzniklo právo (nezpůsobilý zdroj, nesplnění podmínek, ztráta nároku).
2. **Čerpání v nesprávné výši** — výrobce pobírá podporu ve výši vyšší nebo nižší, než odpovídá zákonu.

Zákon výslovně kryje i podporu čerpanou podle **předchozích právních předpisů** (zákon č. 180/2005 Sb.) — institut se tedy uplatní i na „staré" nároky. Přechodná ustanovení § 54 přitom práva z těchto starých zdrojů zachovávají; to nijak nevylučuje zpětné přezkoumání, zda podpora nebyla čerpána v nesprávné výši.

#### Procesní a hmotněprávní rámec

**Rozhodnutí Inspekce ex officio (odst. 1):** SEI rozhoduje z moci úřední, bez návrhu. Zákon nestanoví prekluzivní lhůtu pro vydání tohoto rozhodnutí, nýbrž lhůtu pro stanovení neoprávněné podpory — ta je **10 let** od 1. ledna roku následujícího po roku, v němž k neoprávněnému čerpání došlo (odst. 4). Tím se délka lhůty pro správu placení liší od přestupkové promlčecí doby (§ 50): délka 10 let pro neoprávněně čerpanou podporu vs. 5/8 let pro přestupy.

**Povinnosti výrobce po pravomoci rozhodnutí (odst. 2):**
- Uhradit podporu do **30 dnů** od právní moci rozhodnutí SEI do **státního rozpočtu** (nikoli operátorovi trhu).
- Uhradit **úrok z prodlení podle daňového řádu** (zákon č. 280/2009 Sb.) za dobu neoprávněného čerpání — viz blíže [Komentar-DR-280-2009](../Komentar-DR-280-2009/01-cast1-predmet-zasady.md). Úrok je omezen maximálně výší samotného neoprávněného čerpání.

**Dobrovolná restituce před rozhodnutím (odst. 3):** Výrobce, který vrátí podporu dobrovolně na výzvu SEI ještě **před vydáním rozhodnutí**, nečerpá podporu „neoprávněně" ve smyslu § 51 — zákon takové dobrovolné vrácení odlišuje od neoprávněného čerpání. Praktický důsledek: dobrovolné vrácení nepodléhá úroku z prodlení dle odst. 2 písm. b). Tím zákon motivuje výrobce ke spolupráci se SEI.

Na řízení o neoprávněně čerpané podpoře se použije **správní řád** (zákon č. 500/2004 Sb.) jako obecný procesní předpis — na rozdíl od přestupkového řízení, kde se subsidiárně uplatňuje zákon č. 250/2016 Sb.

#### Správa placení — celní úřady a daňový rámec (odst. 4)
...
§ 52 svěřuje Energetickému regulačnímu úřadu (ERÚ) pravomoc rozhodovat **soukromoprávní spory** o splnění povinnosti uhradit podporu. Jde o tzv. **správní arbitráž** (rozhodování sporů správním orgánem), přičemž ERÚ rozhoduje jako první instance s možností odvolání a následného správního přezkumu.

Věcný rozsah sporů zahrnuje:
- úhradu podpory elektřiny z OZE (výkupní ceny, zelené bonusy, aukční bonusy),
- úhradu podpory elektřiny z druhotných zdrojů,
- úhradu podpory elektřiny z vysokoúčinné kombinované výroby elektřiny a tepla (VKVET),
- úhradu podpory tepla (zelené bonusy na teplo),
- úhradu přechodné transformační podpory tepla,
...
#### Dvojí zmocňovací základ — MPO a ERÚ

§ 53 rozděluje prováděcí pravomoc mezi dvě instituce:

| Subjekt | Zákonný základ | Předmět prováděcích vyhlášek |
|---|---|---|
| **Ministerstvo průmyslu a obchodu** (MPO) | odst. 1, písm. a)–al) | Technické a procesní parametry: druhy a parametry zdrojů, měření, výkaznictví, záruky původu, kritéria udržitelnosti, biometan, vodík, sektorové šetření, deklarační povinnosti |
| **Energetický regulační úřad** (ERÚ) | odst. 2, písm. a)–m) | Ekonomické a regulační parametry: výkupní ceny, zelené bonusy, diskontní míra, doba životnosti, termíny a postupy registrace, složky cen soustav |

Tato dělba reflektuje systémové rozdělení rolí v energetické regulaci: MPO stanovuje technická pravidla výkonu (co se měří, jak se hlásí, co je biometan), ERÚ stanovuje ekonomické podmínky (ceny, bonusy, doby životnosti). Uvedená dělba je funkční i z ústavního hlediska — vyhlášky obou orgánů jsou podzákonné předpisy vydávané v mezích zákonného zmocnění (čl. 79 odst. 3 Ústavy), přičemž zákonné zmocnění musí být dostatečně určité a meze vyhlášek nesmí překračovat zákonný rámec.

#### Šíře zmocnění MPO — 38 položek (odst. 1)

Zmocnění MPO je výjimečně rozsáhlé — zahrnuje 38 věcných oblastí (písm. a) až al)), pokrývající celý technický a dokumentační rámec POZE. Výrazný nárůst oproti původní verzi zákona z roku 2012 reflektuje rozšiřování věcné působnosti POZE (biometan, vodík, záruky původu energie, letecká paliva, transformace tepláren). Každá oblast zmocnění odpovídá konkrétní hmotněprávní části POZE (viz [06-hlava12-doprava-biopaliva-vodik.md](06-hlava12-doprava-biopaliva-vodik.md) pro oblast dopravy a biometanu; [08-casti2-7-zmeny-ucinnost.md](08-casti2-7-zmeny-ucinnost.md) pro celkový kontext novelizací).

#### Zmocnění ERÚ — 13 oblastí (odst. 2)
...
>
> *(18) Korekční faktory související s podporou elektřiny z obnovitelných zdrojů, kombinované výroby elektřiny a tepla a druhotných energetických zdrojů, které náleží provozovateli přenosové soustavy a provozovateli regionální distribuční soustavy za poslední dva kalendářní roky bezprostředně předcházející roku, ve kterém nabyl účinnosti tento zákon, stanoví Úřad v souladu s jiným právním předpisem, který upravuje způsob regulace cen v energetických odvětvích a postupy pro regulace cen ve znění účinném k 31. prosinci 2012. O takto stanovené korekční faktory upraví Úřad složku ceny za přenos elektřiny a ceny za distribuci elektřiny na krytí nákladů spojených s podporou elektřiny účtované operátorem trhu provozovateli regionální distribuční soustavy a provozovateli přenosové soustavy podle § 13 odst. 1 nejpozději do konce druhého kalendářního roku následujícího po kalendářním roce, ve kterém tento zákon nabyl účinnosti.*
>
...
§ 54 zajišťuje **právní kontinuitu** systému podpory pro výrobce, kteří nabyli práva na podporu za účinnosti předchozích právních předpisů — zejména zákona č. 180/2005 Sb. (zákon o podpoře využívání obnovitelných zdrojů). Stěžejní pravidlo je obsaženo v odst. 1 a 2: **starý nárok transformuje v nový nárok** dle POZE, přičemž výkupní ceny (odst. 1) a zelené bonusy (odst. 2) se zachovávají v ekvivalentní výši.

#### Systematika přechodných ustanovení

| Odst. | Téma | Klíčové pravidlo |
|---|---|---|
| 1 | Výkupní ceny pro staré výrobny | Zachování nároku, ERÚ stanoví výši dle starých pravidel; vybrané § POZE se nepoužijí |
| 2 | Zelené bonusy pro staré výrobny | Totéž; možnost přechodu na výkupní ceny (s výjimkou spolu-spalování) |
| 3 | Výrobny nepřipojené ke dni účinnosti | Fiktivní datum uvedení do provozu = rok 2011; nárok podmíněn předchozím čerpáním dle z. 180/2005 Sb. |
| 4 | VKVET a druhotné zdroje (staré) | Transformace na roční ZB; nepoužije se § 5 odst. 3 POZE |
| 5 | Doba trvání nároku | Po dobu životnosti dle starých předpisů |
| 6 | Spolu-spalování OZE + neOZE | Podpora dle starých předpisů trvá do 31. 12. 2015 |
| 7 | Staré záruky a osvědčení původu | Считаются platné dle POZE |
| 8 | Odvod za prosinec 2012 | Speciální lhůta pro podání vyúčtování (25 dnů po nabytí účinnosti) |
| 9–11 | Zánik smluv a ujednání k 31. 12. 2012 | Přesná pravidla pro vyrovnání a předání podkladů |
| 12–13 | Přechod práv a závazků na OTE | Práva a závazky PPS/PRDS přecházejí na operátora trhu k 1. 3. 2013 resp. ke dni účinnosti |
| 14 | Přeregistrace výrobců k OTE | PPS/PRDS zaregistrují výrobce u OTE do 30 dnů od účinnosti |
| 15 | Výjimky pro nové výrobny (24 měs.) | Vybrané podmínky instalace a způsobu podpory se nevztahují na výrobny do provozu do 24 měs. od vyhlášení |
| 16 | Solární výrobny přes zahraniční soustavu | Zvláštní pravidlo pro datum uvedení do provozu |
| 17 | Výrobny bez přímého připojení k ČR | Zvláštní pravidlo pro datum a podmínku předchozího čerpání |
| 18 | Korekční faktory za 2 roky před účinností | ERÚ je zahrne do složek ceny přenosu/distribuce do konce 2. roku po účinnosti |
| 19 | Zánik rezervací výkonu pro FVE před 1. 4. 2010 | Rezervace zanikají ke dni vyhlášení zákona |
| 20 | První stanovení bonusu na teplo a decentrální výrobu | ERÚ poprvé stanoví pro rok 2013 |

#### Klauzule o nepřenosnosti vybraných ustanovení POZE na staré výrobny
...
#### Derogace předchůdce a jeho novel

§ 55 zrušuje **tři právní předpisy**:

| Č. | Zákon | Obsah |
|---|---|---|
| 1 | Zákon č. 180/2005 Sb. | Původní zákon o podpoře OZE (elektřina); základní předchůdce POZE |
| 2 | Zákon č. 137/2010 Sb. | První novela z. 180/2005 Sb. |
| 3 | Zákon č. 330/2010 Sb. | Druhá novela z. 180/2005 Sb. (zavedení solárního odvodu) |
